...
cors.onHeadersReceived = d => {
  ...
  let origin = '*';
    ...
    var o = responseHeaders.find(({name}) => name.toLowerCase() === 'access-control-allow-origin');
    ...
    o = responseHeaders.find(({name}) => name.toLowerCase() === 'access-control-allow-headers');
    if (o) {
      o.value = '*';
    }
    else {
    ...
    o = responseHeaders.find(({name}) => name.toLowerCase() === 'access-control-expose-headers');
    if (o) {
      o.value = '*';
    }
    else {
    ...
    o = responseHeaders.find(({name}) => name.toLowerCase() === 'access-control-allow-origin');
    if (!o || o.value !== '*') {
    ...
    o = responseHeaders.find(({name}) => name.toLowerCase() === 'access-control-allow-methods');
    if (o) {
